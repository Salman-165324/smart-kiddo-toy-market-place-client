  ...
  return (
    <div className="primary-container">
      <div className=" bg-primary rounded-2xl flex flex-col items-center">
        <h1 className="pt-12 pb-4 text-center text-4xl font-bold accent-text-color">
          Welcome, Signup Please!
        </h1>
          ...
          <div className="card flex-shrink-0 mt-4 bg-neutral1 w-full max-w-sm shadow-2xl mb-10 lg:mb-9 ">
            <div className="card-body pb-4">
              <form onSubmit={handleFormSubmission}>
                <div className="form-control">
                  ...
                  <input
                    ...
                    placeholder="name"
                    name="name"
                    className="input bg-neutral1 input-bordered border-[#272253]"
                  />
                </div>
                <div className="form-control">
                  <label className="label">
                ...
                {errorText && (
                  <label className="label mt-1 underline text-base">
                    <p className="link link-hover font-semibold text-red-600">
                      {errorText}
                    </p>
                  </label>
                )}
              ...
              <button
                ...
                className="btn bg-neutral1 accent-text-color flex gap-2 w-full items-center justify-center px-4 py-2.5 border border-accent rounded-md hover:bg-[#f5f2d1]"
              >
              ...
              <label className="label">
                <Link
                  to="/login"
                  className="label-text-alt link link-hover font-semibold text-blue-700"
                >
